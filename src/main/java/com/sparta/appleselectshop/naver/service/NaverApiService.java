package com.sparta.appleselectshop.naver.service;
...
public class NaverApiService {
    ...
    public List<ItemDto> searchItems(String query) {
        ...
        headers.add("X-Naver-Client-Id", "3MLfjKg7Px7sa1bG6GyG");       // 변경 필요
        headers.add("X-Naver-Client-Secret", "HlfLWojTVd");             // 변경 필요
        String body = "";
